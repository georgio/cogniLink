...
\begin{table}[]
  ...
  {\color[HTML]{000000} \textbf{Name}} & {\color[HTML]{000000} \textbf{Cost (USD)}} & {\color[HTML]{000000} \textbf{Link}} \\ \hline
  {\color[HTML]{000000} Ultracortex "Mark IV" EEG Headset} & 999.99 & {\ul https://goo.gl/JRLunf} \\ \hline
  {\color[HTML]{000000} WiFi Shield} & 149.99 & {\color[HTML]{000000} {\ul https://goo.gl/9UTFpB}} \\ \hline
  {\color[HTML]{000000} Cyton + Daisy Biosensing Boards (16-Channels)} & 949.99 & {\ul https://goo.gl/nDMBGQ} \\ \hline
  {\color[HTML]{000000} \begin{tabular}[c]{@{}l@{}}Energizer Rechargeable AA Batteries, NiMH,\\ 2000 mAh, Pre-Charged, 8 count (Recharge Universal)\end{tabular}} & 19.98 & {\ul https://goo.gl/qckQAb} \\ \hline
  {\color[HTML]{000000} Gold Cup Electrodes} & 29.99 & {\ul https://goo.gl/2eckXr} \\ \hline
  {\color[HTML]{000000} ELEFIX EEG Paste - 6 oz tube} & 17.99 & {\color[HTML]{000000} {\ul https://goo.gl/LrkUg6}} \\ \hline
  \rowcolor[HTML]{C0C0C0} 
  \textbf{Total:} & \textbf{2167.93} &  \\ \hline
  \end{tabular}
  \end{table}