...
%% ========================================================
\title{cogniLink$:$ A Non-Invasive Brain-Computer Interface That Enables Seamless Execution of 
...
\bibliographystyle{apacite}       %References go to end of Section III
\bibliography{refs}
