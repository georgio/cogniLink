...
\begin{workpackage}{Model 1 n Commands}
  ...
  \begin{wpobjectives}
    ...
    \begin{enumerate*}
    \item Link the output from the Model to the virtualHID created in WP1;
  ...
  \begin{wpdescription}
    ...
    \wptask{Georgio}{Georgio}{6}{12}{Task1}{
      ...
      Code for linking model to virtualHID will be rechecked and finalized.
    }
  ...
  \begin{wpdeliverables}
    ...
    \wpdeliverable[12]{Georgio}{R}{PU}{Report 2 will comapre the variation of latency between the model and the virtualHID for each code patch.}\label{dev:wp3r2}
    \wpdeliverable[12]{Georgio}{P}{PU}{Code for virtualHID and updated Model 1 with multiple command recognition will be pushed to master.}\label{dev:wp3r1}
    ...
    \wpdeliverable[12]{Georgio}{R}{PU}{Main Report update with full progress accomplished after the end of WP3.}\label{dev:MR0.3}
  \end{wpdeliverables}
